#ifndef CAM_LOC_BENCHMARK_BENCHMARK_H_
#define CAM_LOC_BENCHMARK_BENCHMARK_H_

/// Regression benchmark suite wrapping sequence evaluation.
///
/// Each BenchmarkCase runs RunSequenceEval and checks pose / matching / latency
/// thresholds. Missing dataset paths are skipped (IoError) rather than failing
/// the whole suite.
...
/// One regression scenario (dataset paths, perception mode, CUDA/GT flags,
/// thresholds).
...
///
/// @param data_root Directory holding the datasets -- smoke_kitti/,
///   kitti_odometry/ and perception/. It sits beside the repository rather than
///   inside it; see scripts/lib.sh camloc_data_dir.
...
#endif  // CAM_LOC_BENCHMARK_BENCHMARK_H_
