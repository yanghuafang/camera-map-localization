...
/// over the timed iterations, which follow untimed warm-up calls so that a cold
/// heap and a clock ramping up from idle are not counted as the kernel's cost.
...
/// Run DT + pose-grid image cost benchmarks with smoke-kitti calibration.
