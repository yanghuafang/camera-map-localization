...
// An offset has to move a pose the way a vehicle moves. Applied on cam0 axes
// instead, its second component would sweep camera height and its "yaw" would
// be roll about the optical axis.
